...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between font-medium p-4 rounded-xl border-secondary shadow-lg">
      ...
      >
        <div
          className={`fixed top-0 right-0 h-full w-4/5 max-w-xs bg-brand shadow-2xl transition-transform duration-300 ease-in-out transform ${
            ...
            <div className="flex-1 overflow-y-auto py-2">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block py-3 px-4 rounded-lg transition-colors ${
                      isActive ? "bg-teal-800 text-white" : "hover:bg-gray-700"
                    }`
                  }
                  onClick={mainOptionUnvisible}
                >
              ...
              {token && (
                <div className="px-4 py-2 mt-4 border-t border-gray-700">
                  <h3 className="text-xs uppercase tracking-wider text-gray-500 font-semibold my-2">
                    Account
                  </h3>
                  <button
