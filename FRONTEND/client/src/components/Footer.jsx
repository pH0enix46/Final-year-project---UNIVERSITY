          ...
          <fieldset className="form-control w-80">
            ...
            <div className="join">
              <input
                ...
                required
              />
              <button className="btn join-item rounded-r-full transition-all bg-slate-900 hover:bg-slate-950  text-gray-400 border-gray-900 hover:border-gray-900 text-base">
                Subscribe
              </button>
            </div>
          </fieldset>
